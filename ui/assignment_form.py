...
class AssignmentFormFrame(tk.Frame):
    ...
    def create_widgets(self):
        ...
        # Assignment title
        tk.Label(form_frame, text="Assignment Title:", font=("Arial", 11), bg="white").grid(
            row=0, column=0, sticky="w", pady=5
        )
        self.title_entry = tk.Entry(form_frame, font=("Arial", 11), width=40)
        self.title_entry.grid(row=0, column=1, pady=5, padx=10)
        
        # Course selection
        tk.Label(form_frame, text="Course:", font=("Arial", 11), bg="white").grid(
        ...
        # Assignment type
        tk.Label(form_frame, text="Type:", font=("Arial", 11), bg="white").grid(
        ...
        # Due date
        tk.Label(form_frame, text="Due Date (YYYY-MM-DD):", font=("Arial", 11), bg="white").grid(
            row=3, column=0, sticky="w", pady=5
        )
        self.date_entry = tk.Entry(form_frame, font=("Arial", 11), width=40)
        self.date_entry.grid(row=3, column=1, pady=5, padx=10)
        self.date_entry.insert(0, datetime.now().strftime("%Y-%m-%d"))
        
        # Due time
        tk.Label(form_frame, text="Due Time (HH:MM):", font=("Arial", 11), bg="white").grid(
            row=4, column=0, sticky="w", pady=5
        )
        self.time_entry = tk.Entry(form_frame, font=("Arial", 11), width=40)
        self.time_entry.grid(row=4, column=1, pady=5, padx=10)
        self.time_entry.insert(0, "23:59")
        
        # Status
        tk.Label(form_frame, text="Status:", font=("Arial", 11), bg="white").grid(
        ...
        # Notes
        tk.Label(form_frame, text="Notes (optional):", font=("Arial", 11), bg="white").grid(
            row=6, column=0, sticky="nw", pady=5
        )
        self.notes_text = tk.Text(form_frame, font=("Arial", 10), width=40, height=4)
